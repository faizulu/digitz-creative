...
export const founder = {
  ...
  titleLine: 'Founder & Creator',
  brandLine: 'Digitz Creative',
  place: 'Trichy, Tamil Nadu',
  body: 'I craft meaningful digital experiences that stop the scroll, build brands, and turn creative into real business growth.',
  bodyLong:
    "Digitz Creative is led from the creator's chair. Faizal Ahamed (Foodiee Faizall) builds content for his own audience and for client brands, which is why the work is judged on stop-scroll craft and on business outcomes, not vanity metrics alone.",
...
export const gallery = [
  ...
  },
  {
    id: 'branding',
    title: 'Branding',
    note: 'Identity systems and brand language.',
    cta: 'View Project',
    href: '#contact',
  },
  {
    id: 'campaigns',
    title: 'Campaigns',
    note: 'Marks and kits built to travel.',
    cta: 'View Project',
    href: '#contact',
  },
  {
    id: 'ads',
    title: 'Ads',
    note: 'Meta creatives built for response.',
    cta: 'Case Study',
    href: '#work',
  },
  {
    id: 'social',
    title: 'Social',
    note: 'Always-on presence and community.',
    cta: 'Case Study',
    href: '#contact',
  },
] as const
...
export const testimonials = {
  ...
  items: [
    {
      layout: 'overlap_top' as const,
      headline: 'Good Services!',
      quote: 'Fast kickoff, clear creative, and content that actually converts for our local audience.',
      name: 'Arjun Patel',
      role: 'Owner, Coastal Cafe',
      handle: '@arjunpatel',
      image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=240&h=240&fit=crop&crop=faces',
      rating: true,
    },
    {
      layout: 'quote_corner' as const,
      headline: 'I really appreciate!!',
      quote: 'Strategy, reels, and ads stayed consistent. Our social presence finally feels premium.',
      name: 'Rohan Mehta',
      role: 'CEO, Northbridge Retail',
      handle: '@rohanmehta',
      image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=240&h=240&fit=crop&crop=faces',
      rating: true,
    },
    {
      layout: 'portrait_wide' as const,
      headline: 'Hit the ground running',
      quote:
        'Digitz understood our growth goals fast and built a system we can keep shipping every week.',
      name: 'Karthik S.',
      role: 'Founder, Peak Labs',
      handle: '@karthiks',
      image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=320&h=320&fit=crop&crop=faces',
      stack: [
    ...
    },
    {
      ...
      headline: 'Local, still premium',
      quote: 'A team that gets Trichy brands and still ships work that feels polished worldwide.',
      name: 'Ananya Iyer',
      role: 'Co-founder, Salt & Stone',
      handle: '@ananyaiyer',
      image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=240&h=240&fit=crop&crop=faces',
      rating: false,
    },
    {
      layout: 'tall_photo' as const,
      headline: 'Messaging that lands',
      quote: 'The brand voice does not just read well. You feel it. Content that moves the business.',
      name: 'Dev Rajan',
    ...
    {
      layout: 'compact_center' as const,
      headline: 'Clear and on-brand',
      quote: 'Reliable delivery from kickoff to publish. Easy partnership end to end.',
      name: 'Priya Nair',
      role: 'Director, Lumen Studio',
      handle: '@priyanair',
      image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=240&h=240&fit=crop&crop=faces',
      signature: true,
      rating: true,
    },
    {
      layout: 'portrait_quote' as const,
      headline: 'Direct yet Friendly Tone',
      quote: 'Clear strategy, strong creatives, and follow-through we could trust every sprint.',
      name: 'Vikram N.',
      role: 'Owner, Harbor Goods',
      handle: '@vikramn',
      image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=240&h=240&fit=crop&crop=faces',
      rating: false,
    },
    {
      layout: 'heading_stack' as const,
      headline: 'Tremendous Job Team',
      quote: 'Our inquiries jumped in six weeks. The creatives felt premium without losing local voice.',
      name: 'Martha Wallin',
      role: 'Brand Lead, Nest & Co',
      handle: '@marthaw',
      image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=240&h=240&fit=crop&crop=faces',
      stack: [
    ...
    {
      layout: 'mega_quote' as const,
      headline: 'Steady follow-through',
      quote:
        'They turned scattered ideas into a clear content engine. Our team finally has a rhythm that ships.',
      name: 'Maya Krishnan',
      role: 'Founder, Bloom Botanics',
      handle: '@mayakrishnan',
      image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=320&h=320&fit=crop&crop=faces',
      rating: true,
    },
    {
      layout: 'large_quote' as const,
      headline: 'Results we can measure',
      quote:
        'From first brief to live campaigns, Digitz kept quality high and timelines honest. Exactly the partner we needed.',
      name: 'Sneha Kapoor',
      role: 'CMO, Brightline',
      handle: '@snehak',
      image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=240&h=240&fit=crop&crop=faces',
      signature: true,
      rating: false,
    },
  ],
