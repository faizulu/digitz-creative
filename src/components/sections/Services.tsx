...
export function Services() {
  ...
  return (
    <section
      id="services"
      ref={ref}
      className="services-liquid relative flex w-full items-center overflow-hidden"
      aria-labelledby="services-heading"
    >
      <MagicLiquidCard
        active={inView}
        tone="prism"
        className={`services-magic-panel ${inView ? 'is-in' : ''}`}
      >
        <div className="services-liquid-atmos" aria-hidden>
          <span className="services-liquid-blob services-liquid-blob--mint" />
          <span className="services-liquid-blob services-liquid-blob--sky" />
          <span className="services-liquid-blob services-liquid-blob--peach" />
        </div>

        <div ref={animRootRef} className="relative z-10 flex min-h-0 flex-1 flex-col">
          <Container className="services-liquid-shell">
            <div className="services-liquid-grid">
              <div className="services-liquid-copy gs-reveal">
                ...
                <h2 id="services-heading" className="services-liquid-title">
