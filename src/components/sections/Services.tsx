...
export function Services() {
  ...
  return (
    ...
    >
      <div ref={animRootRef} className="relative z-10 flex min-h-0 w-full flex-1 flex-col">
          ...
          <div className="services-liquid-grid">
            <div className="services-liquid-copy gs-reveal">
              ...
              <h2 id="services-heading" className="services-liquid-title">
                ...
                <ActionWord>{servicesIntro.titleAccent.replace(/\.$/, '')}</ActionWord>
                {servicesIntro.titleAccent.endsWith('.') ? '.' : null}
              </h2>
              ...
              <div className="services-liquid-laptop svc-stage-anim">
                <div className="services-liquid-laptop-bezel">
                  <img
                    ...
                    alt="Restaurant campaign creative on laptop"
              ...
              <div className="services-liquid-phone">
                <div className="services-liquid-phone-screen">
                  <img
                    ...
                    alt="Social campaign creative on phone"
                    width={540}
                    height={960}
                    decoding="async"
                  />
